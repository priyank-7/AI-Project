...
def axiom_generator_at_location_ssa(t, x, y, xmin, xmax, ymin, ymax,heading):
    ...
    elif heading == 'east' and x + 1 <= xmax:
        axioms.append(axiom_generator_at_location_ssa(t, x + 1, y, xmin, xmax, ymin, ymax))
    elif heading == 'south' and y - 1 >= ymin:
        axioms.append(axiom_generator_at_location_ssa(t, x, y - 1, xmin, xmax, ymin, ymax))
    elif heading == 'north' and y + 1 <= ymax:
        axioms.append(axiom_generator_at_location_ssa(t, x, y + 1, xmin, xmax, ymin, ymax))
    axioms = filter(lambda s: s != '', axioms)
...
def axiom_generator_heading_north_ssa(t):
    ...
    t := time
    """
    nomoves = '({0} & ({1} | {2} | {3} | {4} | {5}))'.format(state_heading_north_str(t),action_wait_str(t),action_grab_str(t),action_shoot_str(t),percept_bump_str(t+1),action_forward_str(t))
...
def axiom_generator_heading_east_ssa(t):
    ...
    t := time
    """
    nomoves = '({0} & ({1} | {2} | {3} | {4} | {5}))'.format(state_heading_east_str(t),action_wait_str(t),action_grab_str(t),action_shoot_str(t),percept_bump_str(t+1),action_forward_str(t))
    ...
    axiom_str = '{0} <=> ({1} | {2} | {3})'.format(state_heading_east_str(t+1),nomoves,left_turn,right_turn)
...
def axiom_generator_heading_south_ssa(t):
    ...
    t := time
    """
    nomoves = '({0} & ({1} | {2} | {3} | {4} | {5}))'.format(state_heading_south_str(t),action_wait_str(t),action_grab_str(t),action_shoot_str(t),percept_bump_str(t+1),action_forward_str(t))
    ...
    axiom = '{0} <=> ({1} | {2} | {3})'.format(state_heading_south_str(t+1),nomoves,left_turn,right_turn)
...
def axiom_generator_heading_west_ssa(t):
    ...
    t := time
    """
    nomoves = '({0} & ({1} | {2} | {3} | {4} | {5}))'.format(state_heading_west_str(t),action_wait_str(t),action_grab_str(t),action_shoot_str(t),percept_bump_str(t+1),action_forward_str(t))
    left_turn = '({0} & {1})'.format(state_heading_north_str(t),action_turn_left_str(t))
    righ_turn = '({0} & {1})'.format(state_heading_south_str(t),action_turn_right_str(t))
    axiom = '{0} <=> ({1} | {2} | {3})'.format(state_heading_west_str(t+1),nomoves,left_turn,righ_turn)
...
def axiom_generator_heading_only_north(t):
    ...
    t := time
    """
    axiom = '{0} <=> (~{1} & ~{2} & ~{3})'.format(state_heading_north_str(t), state_heading_south_str(t),state_heading_east_str(t), state_heading_west_str(t))
    return axiom
...
def axiom_generator_heading_only_east(t):
    ...
    t := time
    """
    axiom = '{0} <=> (~{1} & ~{2} & ~{3})'.format(state_heading_east_str(t),state_heading_south_str(t),state_heading_north_str(t),state_heading_west_str(t))
    return axiom
...
def axiom_generator_heading_only_south(t):
    ...
    t := time
    """
    axiom = '{0} <=> (~{1} & ~{2} & ~{3})'.format(state_heading_south_str(t),state_heading_north_str(t),state_heading_east_str(t),state_heading_west_str(t))
    return axiom
...
def axiom_generator_heading_only_west(t):
    ...
    axiom = '{0} <=> (~{1} & ~{2} & ~{3})'.format(state_heading_west_str(t),state_heading_south_str(t),state_heading_east_str(t),state_heading_north_str(t))
    return axiom
